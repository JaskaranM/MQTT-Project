...
class LocationPublisher:
    def __init__(self, root):
        ...
        self.bike_details = {"username": "Bike3", "password": "MQTTBike3", "topic": "mqtt/location/bike3"}
        #creates and stores the tkinter frame
        self.frame = ttk.Frame(self.root, padding="50")
        self.frame.grid(row=0, column=0)
        self.label = ttk.Label(self.frame, text="Track Bike3")
    ...
    def track_location(self):
        ...
        if location.ok:
            ...
            print(f"Current location for Bike3 - Latitude: {latitude}, Longitude: {longitude}")
