...
class LocationPublisher:
    def __init__(self, root):
        ...
        self.bike_details = {"username": "Bike1", "password": "MQTTBike2", "topic": "mqtt/location/bike2"}
        #creates and stores the tkinter frame
        self.frame = ttk.Frame(self.root, padding="50")
        self.frame.grid(row=0, column=0)
        self.label = ttk.Label(self.frame, text="Track Bike2")
    ...
    def track_location(self):
        ...
        if location.ok:
            ...
            print(f"Current location for Bike2 - Latitude: {latitude}, Longitude: {longitude}")
...
def main():
    root = tk.Tk()
    app =     app = LocationPublisher(root)(root)
    root.mainloop()
